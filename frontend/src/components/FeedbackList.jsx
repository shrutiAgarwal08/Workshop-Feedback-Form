          ...
          return (
            <div className="col-6 col-md-3 d-flex" key={index}>
              <div className="card w-100 h-100 " style={{ minHeight: "180px" }}>
                <div className="card-body d-flex flex-column justify-content-between text-center" style={{ color: "#0e3b43" }}>
                  <p>{stars}</p>
                  <p className="card-text lh-sm">"{fb.message}"</p>
                  <h5 className="card-title fs-6 text-uppercase" style={{ color: "#0e3b43", fontFamily: "cursive" }}>-{fb.name}</h5>
                </div>
              </div>
            </div>
          );
